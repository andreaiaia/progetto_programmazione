...
posizione[0]=posX;
posizione[1]=posY;
#define Personaggio CHIOCCIOLINO( 10, posizione, 2, '@', false);
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam){
    ...
    switch(msg)
    {
        ...
        case WM_PAINT:
            ...
            int posizione[2];
            CHIOCCIOLINO.ritorna_posizione(posizione);
            TextOutA(hdc, posizione[0], posizione[1], "@", 1);
		...
		case WM_CHAR: 
            ...
            { 
                case 0x20:          // Process a spacebar.
                    InvalidateRect(hwnd, NULL, true);                       //RedrawWindow(hwnd, NULL, NULL, RDW_ERASE|RDW_INVALIDATE|RDW_NOFRAME|RDW_NOINTERNALPAINT);
                    //funzione di movimento chiocciolino
                break;
				case 'w':           // Process a W.
