...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam){
    ...
    switch(msg)
    {
        ...
        case WM_PAINT:
            ...
            TextOutA(hdc, CHIOCCIOLINO.ritorna_x(), CHIOCCIOLINO.ritorna_y(), "@", 3);
        ...
        break;
        default:
            //InvalidateRgn(hwnd, vita, false);           //rivedere
            //InvalidateRgn(hwnd, punteggio, false);
            //InvalidateRgn(hwnd, scudo, false);          //rivedere
            //InvalidateRgn(hwnd, casachiocciolino, false);            //invalidate solo quando i valori cambiano
        break;
    }
